...
function fcverw_install()
{
    ...
    $db->write_query("
        CREATE TABLE ".TABLE_PREFIX."laender (
            ...
            `lparent` int(15) NOT NULL DEFAULT 0,
            `lverantw` int(15) NOT NULL DEFAULT 0,
    ...
    $db->write_query("
        CREATE TABLE ".TABLE_PREFIX."laender_diplomatie (
            ...
            `dipok` int(1) NOT NULL DEFAULT 0,
            `dipdelete` int(1) NOT NULL DEFAULT 0,
            PRIMARY KEY (`dipid`)
        )
        ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci AUTO_INCREMENT=1
    ");
...
{
    global $mybb, $db, $lang, $page, $action_file, $run_module, $form, $parser, $themen, $diplostatus;
...
// Für die Bearbeitung und einzelne Unterpunkte gibt es extra welche
        ...
        $desc2 = '<table width="35%" border="0">
            <tr>
                <td colspan="4" class="smalltext"><b>Symbolerkl&auml;rung</b></td>
            </tr>
            <tr>
                <td width="20%" class="smalltext">Funktion</td>
                <td width="20%" class="smalltext"><img src="fcverw/frei.png"></td>
                <td width="20%" class="smalltext"><img src="fcverw/vergeben.png"></td>
                <td width="40%" class="smalltext"><img src="fcverw/error.png"></td>
            </tr>
            <tr>
                <td class="smalltext">Allgemein</td>
                <td class="smalltext">Land frei</td>
                <td class="smalltext">Land vergeben</td>
                <td class="smalltext">Land vergeben o. Verantwortl.</td>
            </tr>
            <tr>
                <td class="smalltext">L&auml;nderinfo</td>
                <td class="smalltext">Info vorhanden</td>
                <td class="smalltext">Info fehlt</td>
                <td class="smalltext">Info nicht freigegeben</td>
            </tr>
            <tr>
                <td class="smalltext">Diplomatie</td>
                <td class="smalltext"></td>
                <td class="smalltext"></td>
                <td class="smalltext"></td>
            </tr>
            <tr>
                <td class="smalltext">Verwandtschaft</td>
                <td class="smalltext"></td>
                <td class="smalltext"></td>
                <td class="smalltext"></td>
            </tr>
            <tr>
                <td class="smalltext">Bewohner</td>
                <td class="smalltext"></td>
                <td class="smalltext"></td>
                <td class="smalltext"></td>
            </tr>
        ...
        // d. Länder - Länderinfos
        require_once MYBB_ROOT.'inc/plugins/fcverw/fcverw_adminLandinfo.php';
        
        
        // e.
        require_once MYBB_ROOT.'inc/plugins/fcverw/fcverw_adminBewohner.php';
        
        // f.
        require_once MYBB_ROOT.'inc/plugins/fcverw/fcverw_adminVerwandtschaft.php';
        
        // g. Länder - Diplomatie
        require_once MYBB_ROOT.'inc/plugins/fcverw/fcverw_adminDiplomatie.php';
