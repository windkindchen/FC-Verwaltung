                    ...
                    while ($landdata = $db->fetch_array($query))
                    {
                        ...
                        if ($landdata['ldelete'] == '0')
                        {
                            ...
                            elseif ($db->num_rows($landinfosel) == "1" && $landinfo['lifreigabe'] == "0")
                            {
                                $popup4->add_item(
                                    "kontrollieren",
                                    "index.php?module=config-fcverw&amp;action=control_landinfo&amp;landid=".$landdata['landid']
                                );
                                $popup4->add_item(
                                    "editieren",
                            ...
                            // Wenn eine Info da und bereits freigegeben
                            elseif ($db->num_rows($landinfosel) == "1" && $landinfo['lifreigabe'] == "1")
                            {
                                $popup4->add_item(
                                    "freigegebene anzeigen",
                                    "index.php?module=config-fcverw&amp;action=show_landinfo&amp;archive=0&amp;landid=".$landdata['landid']
                                );
                                $popup4->add_item(
                                    "neue Version",
                                    "index.php?module=config-fcverw&amp;action=new_landinfo&amp;landid=".$landdata['landid']
                                );
                                
                                $liimage = "frei";
                            }
                            // mehr als eine, die aktuellste noch nicht freigegeben
                            elseif ($db->num_rows($landinfosel) > "1" && $landinfo['lifreigabe'] == '0')
                            {
                                $popup4->add_item(
                                    "kontrollieren",
                                ...
                                $popup4->add_item(
                                    "aktuellste freigegebene anzeigen",
                                    "index.php?module=config-fcverw&amp;action=show_landinfo&amp;archive=0&amp;landid=".$landdata['landid']
                                );
                                $popup4->add_item(
                            ...
                            // mehr als eine Version vorhanden, aktuellste freigegeben
                            elseif ($db->num_rows($landinfosel) > "1" && $landinfo['lifreigabe'] == '1')
                            {
                                $popup4->add_item(
                                    "aktuellste freigegebene anzeigen",
                            ...
                            $form_container->output_cell('<img src="fcverw/'.$liimage.'.png"> '.$popup4->fetch(), array("class" => "align_center"));
                            ...
                            foreach($diplostatus AS $statusid => $statusname)
                            {
                                $popup5->add_item(
                                    $statusname,
                                    "index.php?module=config-fcverw&amp;action=edit_diplo&amp;landid=".$landdata['landid']."&amp;diplostat=".$statusid
                                );
                            }
                    ...
                    while ($landdata2 = $db->fetch_array($query2))
                    {
                        ...
                        if ($landdata2['ldelete'] == "1")
                        {
                            ...
                            if ($landinfo > 0)
                            {
                                ...
                                $popup3->add_item(
                                    "Anzeigen",
                                    "index.php?module=config-fcverw&amp;action=show_landinfo&amp;archive=1&amp;landid=".$landdata2['landid']
                                );
                            ...
                            $popup5->add_item(
                                "anzeigen",
                                "index.php?module=config-fcverw&amp;action=show_diplo&amp;landid=".$landdata2['landid']
                            );
                            $form_container->output_cell($popup5->fetch(), array("class" => "align_center"));
                            ...
                            $popup6->add_item(
                                "anzeigen",
                                "index.php?module=config-fcverw&amp;action=show_verwandt&amp;landid=".$landdata2['landid']
                            );
                            $form_container->output_cell($popup6->fetch(), array("class" => "align_center"));
                            ...
                            $popup7->add_item(
                                "anzeigen",
                                "index.php?module=config-fcverw&amp;action=show_chars&amp;landid=".$landdata2['landid']
                            );
                            $form_container->output_cell($popup7->fetch(), array("class" => "align_center"));
                        }
        ...
        {   
            ...
            else
            {
                ...
                $sub_tabs['edit_land'] = array(
                    ...
                    'link' => 'index.php?module=config-fcverw&amp;action=edit_land&amp;landid='.$mybb->input['landid'],
            ...
            if ($land['lstat'] == '0')
            {
                ...
                if ($db->num_rows($childs) == '0')
                {
                    ...
                    if ($probe == '0')
                    {
                        ...
                        // IDs bei Diplomatie ändern
                        $ldipupdate1 = array(
                            "diplandid" => $newID
                        );
                        $db->update_query("laender_diplomatie", $ldipupdate1, "diplandid = ".$land['landid']);
                        
                        $ldipupdate2 = array(
                            "dippartid" => $newID
                        );
                        $db->update_query("laender_diplomatie", $ldipupdate2, "dippartid = ".$land['landid']);
                        
                        
                        // IDs bei Verwandtschaft ändern
                        $verwupdate1 = array(
                            "landid" => $newID
                        );
                        $db->update_query("laender_verwandt", $verwupdate1, "landid = ".$land['landid']);
                        
                        $verwupdate2 = array(
                            "verwid" => $newID
                        );
                        $db->update_query("laender_verwandt", $verwupdate2, "verwid = ".$land['landid']);
                        
                        
                        // IDs bei Personen ndern
                        $bewohnerup = array(
                            "landid" => $newID
                        );
                        $db->update_query("laender_personen", $bewohnerup, "landid = ".$land['landid']);
